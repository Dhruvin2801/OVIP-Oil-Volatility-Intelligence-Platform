...
def main():
    ...
    with n1:
        if st.button("🌍 **Select Target Market**", use_container_width=True):
            route_to_page("Country_Selector")
